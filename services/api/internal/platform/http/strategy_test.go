...
func TestStrategyErrorReturnsSafeEvaluationDiagnostics(t *testing.T) {
	tests := []struct {
		...
		{strategy.ErrCommitMandateWindowClosed, stdhttp.StatusUnprocessableEntity, "COMMIT_MANDATE_WINDOW_CLOSED"},
		...
		{strategy.ErrEvaluationMarketDataDelayed, stdhttp.StatusUnprocessableEntity, "MARKET_DATA_DELAYED"},
		{strategy.ErrEvaluationMarketDataUnconfirmed, stdhttp.StatusUnprocessableEntity, "MARKET_DATA_REALTIME_UNCONFIRMED"},
		{strategy.ErrEvaluationMarketDataNotRealtime, stdhttp.StatusUnprocessableEntity, "MARKET_DATA_NOT_REALTIME"},
