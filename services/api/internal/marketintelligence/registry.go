...
func DefaultSources() []Source {
	return []Source{
		...
		{ID: "coinbase_exchange", Label: "Coinbase Public Markets", Role: MarketObservation, Feed: "rest_ticker_candles_and_book", Quality: RealTimeSingleVenue, Capabilities: []Capability{CryptoMarkets, CryptoCandles, CryptoLiquidity}},
