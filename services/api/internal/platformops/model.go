...
type ExecutionBoundary struct {
	...
	UnsafeAIInstances             int64 `json:"unsafe_ai_instances"`
	UnsafeAIExecutions            int64 `json:"unsafe_ai_executions"`
...
type Overview struct {
	...
	ActiveAIPaperInstances          int64             `json:"active_ai_paper_instances"`
