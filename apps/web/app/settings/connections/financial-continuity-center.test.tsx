...
describe("FinancialContinuityCenter", () => {
  ...
  it.each([
    ...
    ["AUTHORIZATION_FAILED", "AUTHORIZATION_REVIEW"],
    ["INVALID_CREDENTIAL_FORMAT", "AUTHORIZATION_REVIEW"],
    ["ACCOUNT_NOT_FOUND", "AUTHORIZATION_REVIEW"],
    ["PERMISSION_DENIED", "AUTHORIZATION_REVIEW"],
