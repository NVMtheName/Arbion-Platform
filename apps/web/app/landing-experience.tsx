      ...
      <section className="landing-hero">
        ...
        >
          ...
          <motion.p className="landing-lede" variants={reveal}>
            Connect your accounts. Choose your model. Build your strategy. A
            single workspace for your portfolio and AI—where every decision has
            a source, a boundary, and a record.
          </motion.p>
